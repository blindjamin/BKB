...
| 13 | Diseño (`docs/09` §12.4): [x] DS-1 hecho · [x] **Paso B (DS-2 y DS-3)** hecho (24-09-2026: 271 pruebas OK, CSP limpio, login, empresas, formularios, gestión y contraseñas) · **Paso C (DS-4 y DS-5)** ← **empezar aquí** · Paso D (DS-6 y DS-7) | `benjamin/2026-09-24-portal-diseno` |
